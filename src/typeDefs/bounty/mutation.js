...
const mutationDefs = gql`
  extend type Mutation {
		...
		watchBounty(userAddress: String, contractAddress: String, signature: String): Bounty
		unWatchBounty(userAddress: String, contractAddress: String, signature: String): Bounty
