...
const SET_HACKATHON_BLACKLIST = gql`
	mutation SetHackathonBlacklist(
		$repositoryId: String!
		$hackathonBlacklisted: Boolean!
	) {
		setHackathonBlacklist(
			repositoryId: $repositoryId
			hackathonBlacklisted: $hackathonBlacklisted
		) {
			id
...
const WATCH_BOUNTY = gql`
	mutation WatchBounty(
...
const CREATE_USER = gql`
	mutation CreateUser($github: String, $email: String) {
...
const UNWATCH_BOUNTY = gql`
	mutation UnwatchBounty(
		$contractAddress: String!
		$userId: String!
		$github: String
		$email: String
...
const GET_USER = gql`
	query GetUser($id: String, $email: String, $github: String) {
...
const BLACKLIST_ORGANIZATION = gql`
...
const UPSERT_SUBMISSION = gql`
	mutation upsertSubmission(
		$submissionId: String!
		$blacklisted: Boolean
		$repositoryId: String!
	) {
...
const ADD_USER_TO_SUBMISSION = gql`
	mutation AddUser(
		$repositoryId: String!
		$submissionId: String!
		$userId: String!
...
const REMOVE_USER_FROM_SUBMISSION = gql`
	mutation RemoveUser($submissionId: String!, $userId: String!) {
...
const UPSERT_PRICES = gql`
	mutation UpsertPrices($priceObj: JSON!, $pricesId: String!) {
...
const UPDATE_BOUNTY_VALUATION = gql`
	mutation UpdateBountyValuation(
		...
		updateBountyValuation(address: $address, tvl: $tvl, tvc: $tvc) {
			address
		}
	}
`;
